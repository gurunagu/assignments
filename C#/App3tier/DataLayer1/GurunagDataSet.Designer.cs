...
namespace DataLayer1 {
    ...
    public partial class GurunagDataSet : global::System.Data.DataSet {
        ...
        public partial class EmpDataDataTable : global::System.Data.TypedTableBase<EmpDataRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmpDataRow AddEmpDataRow(int no, string name) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmpDataRow FindByno(int no) {
        ...
        public partial class EmpDataRow : global::System.Data.DataRow {
            ...
            public int no {
                get {
                    return ((int)(this[this.tableEmpData.noColumn]));
                }
                set {
                    this[this.tableEmpData.noColumn] = value;
                }
            }
...
namespace DataLayer1.GurunagDataSetTableAdapters {
    ...
    public partial class EmpDataTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[EmpData] WHERE (([no] = @Original_no) AND ((@IsNull_name = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[EmpData] ([no], [name]) VALUES (@no, @name);\r\nSELECT no, name " +
                "FROM EmpData WHERE (no = @no)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[EmpData] SET [no] = @no, [name] = @name WHERE (([no] = @Original_no" +
                ") AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)));\r\nSE" +
                "LECT no, name FROM EmpData WHERE (no = @no)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataLayer1.Properties.Settings.Default.GurunagConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT no, name FROM dbo.EmpData";
        ...
        public virtual int Fill(GurunagDataSet.EmpDataDataTable dataTable) {
        ...
        public virtual GurunagDataSet.EmpDataDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            GurunagDataSet.EmpDataDataTable dataTable = new GurunagDataSet.EmpDataDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(GurunagDataSet.EmpDataDataTable dataTable) {
